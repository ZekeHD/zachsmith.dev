...
<div>
  <div class="descriptions left-align">
    ...
    <div class="titles-portrait__container">
      <div class="titles">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M64 96c0-35.3 28.7-64 64-64h384c35.3 0 64 28.7 64 64v256h-64V96H128v256H64zM0 403.2C0 392.6 8.6 384 19.2 384h601.6c10.6 0 19.2 8.6 19.2 19.2 0 42.4-34.4 76.8-76.8 76.8H76.8C34.4 480 0 445.6 0 403.2M281 209l-31 31 31 31c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0l-48-48c-9.4-9.4-9.4-24.6 0-33.9l48-48c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9zm112-34 48 48c9.4 9.4 9.4 24.6 0 33.9l-48 48c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l31-31-31-31c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0z"/></svg>
        <p class="emphasis-red">full-stack web engineer</p>
        ...
        <p class="emphasis-red">video editor</p>
        ...
        <p class="emphasis-red">sound designer</p>
        ...
        <svg class="top" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          ...
          <svg style="fill:#d61600" preserveAspectRatio="xMidYMid meet" viewBox="0 50 350 350" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="text-group">
          <p class="emphasis-red parent-text">professional bad guitar player</p>
          <p class="child-text">(don't let me near one)</p>
        </div>
      </div>
...
.titles-portrait__container {
  ...
  .titles svg {
    align-self: center;
    grid-column: icon-start / text-start;
    text-align: center;
    width: 0.8em;
    fill: $off-white;
    height: 0.7em;
  ...
  .titles p, .titles .text-group {
    grid-column: text-start / text-end;
  }

  .text-group .child-text {
